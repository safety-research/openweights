...
class ApiConfig(BaseModel):
    ...
    quantization: Optional[str] = Field(..., description="--quantization arg for vllm serve")
    kv_cache_dtype: Optional[str] = Field(..., description="--kv_cache_dtype arg for vllm serve")
